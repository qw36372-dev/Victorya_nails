...
ADMIN_IDS: set = {123456789}

# ── Данные мастера ────────────────────────────────────────────────────────────
MASTER_NAME     = "Анна Смирнова"           # Ваше имя
MASTER_BIO      = "Мастер маникюра и педикюра, опыт 7 лет 💅"
SALON_NAME      = f"Мастер {MASTER_NAME}"
SALON_ADDRESS   = "ул. Цветочная, 15"
SALON_PHONE     = "+7 (900) 123-45-67"
SALON_WHATSAPP  = "+7 (900) 123-45-67"
SALON_INSTAGRAM = "@anna_nails"
SALON_METRO     = "м. Цветной бульвар, 5 мин пешком"
